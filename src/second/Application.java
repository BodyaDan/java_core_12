...
public class Application {
    public static void main(String[] args) {
        ...
        ArrayList<Months.Season> Slist = new ArrayList<Months.Season>();
        for (Months.Season obj : Months.Season.values())
            Slist.add(obj);
        while (true) {
            boolean flag;
            Functions.menu();
                ...
                case 6:
                    ...
                    if (Functions.checkSeason(Entered_Season)) {
                        ...
                        if (a == (Months.Season.values().length - 1)) {
                            a = 0;
                            System.out.println(Slist.get(a));
                        }
                        else {
                            System.out.println(Slist.get(a + 1));
                        }
                    }
                    break;
                case 7:
